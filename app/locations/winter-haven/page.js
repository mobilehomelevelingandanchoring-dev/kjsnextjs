...
export default function WinterHavenPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">Pressure Washing in Winter Haven, FL</h1>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Residential & Commercial Cleaning in Winter Haven, FL
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Professional Pressure Washing Services in Winter Haven</h2>
            <p className="text-lg text-gray-700 mb-4">
              We serve Winter Haven with top-quality pressure washing for homes and businesses. From house exteriors to driveways, we deliver exceptional results.
            </p>
